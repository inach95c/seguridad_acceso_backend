    ...
    private Set<Usuario.Rol> resolverRolesDestino(TipoEvento tipo) {
        switch (tipo) {
            ...
            case ALERTA_SEGURIDAD:
             ...
             // Nuevo tipo: solicitudes de residentes
            case SOLICITUD_RESIDENTE:
                return EnumSet.of(Usuario.Rol.RESIDENTE, Usuario.Rol.GUARDIA, Usuario.Rol.GERENTE_ADMIN, Usuario.Rol.MASTER_ADMIN);
